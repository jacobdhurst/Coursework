...
import ControlSystem.tests.EmergencyModeTest;
import ControlSystem.tests.TimedModeTest;
import ControlSystem.tests.ResponsiveTest;
...
class TestTCS extends Thread {
    ...
    public void begin() {
        /* Run ModeController */
        new ModeController(new Scheduler(), 1).run();
